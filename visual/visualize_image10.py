...
transformer = torch.load('/home/gpu/Experiment/xl/model/model_image10_30.pkl')
transformer.cuda()
# 上色
...
def clour_model(transformer, all_data_loader):
    ...
    print(class_count)
    cv2.imwrite("/home/gpu/Experiment/xl/clour_images/Shanghai3.png", out_clour)
    cv2.imwrite("/home/gpu/Experiment/xl/clour_images/Shanghai_gt.png", gt_clour)
